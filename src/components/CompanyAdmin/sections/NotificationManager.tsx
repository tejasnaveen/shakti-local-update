...
export const NotificationManager: React.FC = () => {
    ...
    const fetchAlerts = useCallback(async () => {
        ...
        try {
            setLoading(true);
            const data = await AlertService.getAlertsByTenant(user.tenantId);
            setAlerts(data);
        } catch (error) {
        ...
        <div className="space-y-6 animate-fade-in">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">Send and manage system-wide notifications and alerts</p>
                </div>
